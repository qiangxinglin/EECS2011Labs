...
public class DoubleProbeHashMap<K, V> extends ProbeHashMap<K, V> {
  ...
  /**
    ...
    protected void resize(int newCap) {
        q = selectSecondaryHashPrime(newCap); // reselect secondary prime
        super.resize(newCap); //ensure new capacity is prime
    }
    ...
    protected int findSlot(int h1, K k) {
        ...
        } while (nProbes < capacity);                 // stop if we have probed all locations
